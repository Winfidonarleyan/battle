...
int mainImpl(int argc, char** argv)
{
	...
	TC_LOG_INFO("server.authserver", "   Основано на TrinityCore(master branch)                 ");
	TC_LOG_INFO("server.authserver", "   Приватная версия The Battle Core!                      ");
	TC_LOG_INFO("server.authserver", "   https://bitbucket.org/Vitup/battlecore\n               ");
