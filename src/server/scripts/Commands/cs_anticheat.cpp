...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        {
            { "global",         rbac::RPAC_PERM_COMMAND_ANTICHEAT_GLOBAL,     true,  &HandleAntiCheatGlobalCommand,         "", NULL },
            { "player",         rbac::RPAC_PERM_COMMAND_ANTICHEAT_PLAYER,     true,  &HandleAntiCheatPlayerCommand,         "", NULL },
            { "delete",         rbac::RPAC_PERM_COMMAND_ANTICHEAT_DELETE,    true,  &HandleAntiCheatDeleteCommand,         "", NULL },
            { "handle",         rbac::RPAC_PERM_COMMAND_ANTICHEAT_HANDLE,    true,  &HandleAntiCheatHandleCommand,         "", NULL },
            { "jail",           rbac::RPAC_PERM_COMMAND_ANTICHEAT_JAIL,     true,  &HandleAnticheatJailCommand,           "", NULL },
            { NULL,             0,                   			 false, NULL,                                  "", NULL }
        };

        static ChatCommand commandTable[] =
        {
            { "anticheat",      rbac::RPAC_PERM_COMMAND_ANTICHEAT,     true, NULL,                     "",  anticheatCommandTable},
            { NULL,             0,            				     false, NULL,                    "", NULL }
        };
