    ...
    public:
        ...
        class spell_gen_toss_your_luck_SpellScript : public SpellScript
        {
            ...
            void HandleScriptEffect(SpellEffIndex effIndex)
            {
                ...
                player->Talk(77900, CHAT_MSG_EMOTE, 20.f, NULL);
                player->Talk(roll_chance_i(50) ? 77901 : 77902, CHAT_MSG_EMOTE, 20.f, NULL);
            }

            void Register() override
            {
                OnEffectHitTarget += SpellEffectFn(spell_gen_toss_your_luck_SpellScript::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
