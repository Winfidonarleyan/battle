...
int mainImpl(int argc, char** argv)
{
    ...
    TC_LOG_INFO("server.worldserver", "   Основано на TrinityCore(master branch)                 ");
    TC_LOG_INFO("server.worldserver", "   Приватная версия The Battle Core!                      ");
    TC_LOG_INFO("server.worldserver", "   https://bitbucket.org/Vitup/battlecore\n               ");
